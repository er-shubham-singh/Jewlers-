...
//               <Link 
//                 to={item.link} 
//                 className="flex items-center space-x-2 hover:text-yellow-400 transition-all duration-300 relative"
//               >
//                 <img src={item.imageIcon} alt={item.name} className="w-5 h-5" />
//                 <span>{item.name}</span>

//                 {/* Underline Animation */}
//                 <span className="absolute left-1/2 bottom-0 h-[2px] bg-yellow-400 w-0 group-hover:w-full transition-all duration-300 transform -translate-x-1/2"></span>
//               </Link>

//               {/* Dropdown */}
//               {openDropdown === index && item.dropdown.length > 0 && (
//                 <div 
//                   className="absolute left-0 top-full mt-2 bg-white text-gray-900 rounded-lg shadow-lg w-56 z-50"
//                   onMouseEnter={() => setOpenDropdown(index)}
//                   onMouseLeave={() => setOpenDropdown(null)}
//                 >
