...
const products = [
  {
    ...
    image2: "https://www.tanishq.co.in/on/demandware.static/-/Sites-Tanishq-product-catalog/default/dwafcff930/images/hi-res/50F4I1FALAA32_3.jpg" 
  },
  {
    id: 2,
                ...
                <SwiperSlide key={product.id}>
                  <Link>
                    <div className="relative w-full h-[320px] sm:h-[400px] md:h-[450px] lg:h-[400px] overflow-hidden group">
                      ...
                      />
                      <img
                        src={product.image2}                        alt="Hover Image"
